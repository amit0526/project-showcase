...
export default function HeroLeft() {
  return (
    ...
    >
      ...
      >
        Build
        <span className="block bg-gradient-to-r- from-indigo-600 via-purple-600 to-blue-500 bg-clip-text ">
          Amazing Web Apps
        </span>
      </motion.h1>
      ...
      <motion.div variants={item} className="mt-10 flex flex-wrap gap-4">
        <Link
          to="/projects"
          className="group inline-flex items-center gap-2 rounded-2xl bg-linear-to-r from-indigo-600 to-purple-600  px-7 py-4 font-semibold text-white shadow-xl transition-all duration-300 hover:-translate-y-1 hover:shadow-indigo-300"
        >
          Explore Projects
